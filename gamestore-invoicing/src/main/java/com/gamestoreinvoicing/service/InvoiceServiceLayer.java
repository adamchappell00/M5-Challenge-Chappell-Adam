package com.gamestoreinvoicing.service;

import com.gamestoreinvoicing.client.ProductClient;
import com.gamestoreinvoicing.model.Invoice;
import com.gamestoreinvoicing.model.ProcessingFee;
import com.gamestoreinvoicing.model.Tax;
import com.gamestoreinvoicing.repository.InvoiceRepository;
import com.gamestoreinvoicing.repository.ProcessingFeeRepository;
import com.gamestoreinvoicing.repository.TaxRepository;
import com.gamestoreinvoicing.viewmodel.ConsoleViewModel;
import com.gamestoreinvoicing.viewmodel.GameViewModel;
import com.gamestoreinvoicing.viewmodel.InvoiceViewModel;
...
public class InvoiceServiceLayer {
    ...
    @Autowired
    public InvoiceServiceLayer(InvoiceRepository invoiceRepo, TaxRepository taxRepo, ProcessingFeeRepository processingFeeRepo, ProductClient productClient) {
    ...
    public InvoiceViewModel createInvoice(InvoiceViewModel invoiceViewModel) {
        ...
        if (invoiceViewModel.getItemType().equals(CONSOLE_ITEM_TYPE)) {
            ...
            Optional<ConsoleViewModel> returnVal = productClient.getConsoleById(invoiceViewModel.getItemId());
            ...
            Optional<GameViewModel> returnVal = productClient.getGameById(invoiceViewModel.getItemId());
            ...
            Optional<TShirtViewModel> returnVal = productClient.getTShirtById(invoiceViewModel.getItemId());
